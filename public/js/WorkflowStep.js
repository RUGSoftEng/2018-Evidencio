...
Vue.component("WorkflowStep", __webpack_require__(246));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slider_component__ = __webpack_require__(248);
          ...
          variable.type == "continuous"
            ? _c("div", [
                  ...
                  [
                    _c("vue-slider", {
                      attrs: {
                        ...
                        value: _vm.answers[variable.id]
                      },
                      on: {
                        input: function($event) {
                          _vm.sliderChange(variable.id, $event)
                        }
                      }
                    })
                  ],
                ...
                _c("input", {
                  directives: [
                    {
                      ...
                      rawName: "v-model",
                      value: _vm.answers[variable.id],
                      expression: "answers[variable.id]"
                    }
                  ],
                  key: varIndex,
                  attrs: {
                  ...
                  domProps: { value: _vm.answers[variable.id] },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.answers, variable.id, $event.target.value)
                    }
                  }
                })
              ])
                    ...
                    return _c("div", { key: optIndex }, [
                      _c("input", {
                        ...
                        attrs: {
                          ...
                          name: _vm.answers[option.id]
                        },
                        domProps: {
                          value: option.title,
                          checked: _vm._q(
                            _vm.answers[variable.id],
                            option.title
                          )
                        },
                        on: {
                          change: function($event) {
                            _vm.$set(_vm.answers, variable.id, option.title)
                          }
                        }
                      }),
                      _vm._v(" "),
