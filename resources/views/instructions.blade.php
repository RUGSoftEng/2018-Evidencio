...
<div class="container">
	<div class="card">
		<div class="card-header">
			<h3 class="card-title">Instructions</h5>
		</div>
		<div class="card-body" data-spy="scroll" data-target=".navbar" data-offset="50">
			...
			<ol>
				...
				<li>
					...
					<img src="{{ URL::to('/images/instructions_1.JPG') }}">
				</li>
				<div>
				...
				<li>
					...
					<img src="{{ URL::to('/images/instructions_2.JPG') }}">
				</li>
				</div>
				...
				<li>
					...
					<img src="{{ URL::to('/images/instructions_3a.JPG') }}">
					<img src="{{ URL::to('/images/instructions_3b.JPG') }}">
				</li>
				</div>
				...
				<li>
					...
					<img src="{{ URL::to('/images/instructions_4.JPG') }}">
				</li>
				</div>
				...
				<li>
					...
					<img src="{{ URL::to('/images/instructions_4_5.JPG') }}">
					...
					<ol>
						...
						<li>
							...
							<img src="{{ URL::to('/images/instructions_5.JPG') }}">
						</li>
						</div>
						...
						<li>
							...
							<ul>
								...
								<li>
									...
									<img src="{{ URL::to('/images/instructions_6c.JPG') }}">
								</li>
							</ul>
						</li>
						</div>
						...
						<li>
							...
							<ul>
								<li>
									...
									<img src="{{ URL::to('/images/instructions_8a.JPG') }}">
								</li>
								<li>
